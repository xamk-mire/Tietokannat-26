...
- [00 – Johdanto](00-Introduction.md) — Mikä on tietokanta ja miksi niitä kehitettiin?
- [04 – PostgreSQL](04-PostgreSQL.md) — Johdanto PostgreSQLiin
- [05 – SQL-perusteet](05-SQL-fundamentals.md) — Taulujen rakentaminen ja kyselyt SQL:llä
- [13 – Entity Framework Core](13-Entity-Framework-Core.md) — Käytännön ORM .NET-sovelluksille
- [14 – Käyttäjien ja roolien hallinta ohjelmoinnissa](14-Managing-Users-and-Roles-in-Programming.md) — Sovellustason käyttäjät, roolit ja tietokantakäyttö
